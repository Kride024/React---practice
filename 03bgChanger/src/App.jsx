...
function App() {
  ...
  return (
   ...
   <div className="fixed flex flex-wrap bottom-12 left-auto inset-x-0 px-2">
  ...
  <button onClick={()=>setColor("black")} className="outline-none px-4  py-1 rounded-full text-white shadow-lg " style={{backgroundColor:"grey" }}>Black</button>  
    </div>
   </div>
    </div>
  )
